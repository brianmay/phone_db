...
let
  sources = {
    ...
    "sass-loader-16.0.3" = {
      ...
      version = "16.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/sass-loader/-/sass-loader-16.0.3.tgz";
        sha512 = "gosNorT1RCkuCMyihv6FBRR7BMV06oKRAs+l4UMp1mlcVg9rWN6KMmUj3igjQwmYys4mDP3etEYJgiHRbgHCHA==";
      };
    };
    "schema-utils-3.3.0" = {
      name = "schema-utils";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."mini-css-extract-plugin-2.9.2"
